...
import SearchBar from "../../features/common/components/Input/SearchBar"
    ...
    return(
        <div className="inline-block float-right">
            ...
            <div className="dropdown dropdown-bottom dropdown-end">
                <label tabIndex={0} className="btn btn-sm btn-outline"><FunnelIcon className="w-5 mr-2 h-3"/>Filter</label>
